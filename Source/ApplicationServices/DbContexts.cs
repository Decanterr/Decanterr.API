...
public static class DbContexts
{
	...
	public static LibraryBook? GetLibraryBook_Flat_NoTracking(string productId, bool caseSensative = true, bool includeDeleted = false)
	{
		using var context = GetContext();
		return context.GetLibraryBook_Flat_NoTracking(productId, caseSensative, includeDeleted);
	}
}
